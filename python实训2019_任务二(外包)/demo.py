...
excel_file_names = os.listdir(r'C:/Users/HP/Desktop/Python实训2019/python实训2019/任务2_中风发病因素分析_数据/Appendix-C1')
...
def get_messages(params):
    ...
    for excel_file_name in excel_file_names:
        ...
        for i in range(1, sheet.nrows):
            ...
            """
    if (x == 0):
        print("Appendix-C1的excel文件中年龄和性别出错、职位出错、发病时间、诊断时间出错的数目分别是:{},{},{},{},{}".format(age_wrror, sex_error,Occupation_error, incidence_error,rebort_error))
